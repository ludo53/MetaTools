...
#[derive(Debug)]
pub struct MetaToolsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaToolsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaTools processing");
    
    let mut processor = MetaToolsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaToolsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaToolsProcessor::new(false);
